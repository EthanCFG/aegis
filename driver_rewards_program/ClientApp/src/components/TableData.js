  ...
  return (
    <tbody>
      {driversData.map((driver) => {
        ...
        /*
          The below code might break if sponsorid > 3
        */

        if (driver.Organization_ID1 == localStorage.getItem("sponsorid")) {
          org = 1;
          points = driver.Driver_Points1;
        } else if (
          driver.Organization_ID2 == localStorage.getItem("sponsorid")
        ) {
          org = 2;
          points = driver.Driver_Points2;
        } else if (
          driver.Organization_ID3 == localStorage.getItem("sponsorid")
        ) {
          org = 3;
