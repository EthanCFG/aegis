            ...
            <tr key={id}>
                ...
                <td>
                    <DropdownButton id="dropdown-basic-button" title="Manage">
                        <Dropdown.Item onClick={() => { props.setAddModal(true); props.setDriver(id); props.setOrg(org) }}>Add Points</Dropdown.Item>
                        <Dropdown.Item onClick={() => { props.setSubModal(true); props.setDriver(id); props.setOrg(org) }}>Subtract Points</Dropdown.Item>
                        <Dropdown.Item onClick={() => {setSelectedDriverID(id); setControllingDriver(true);}}>Enter Driver View</Dropdown.Item>
                        <Dropdown.Divider></Dropdown.Divider>
                        <Dropdown.Item onClick={() => { props.setRemoveModal(true); props.setRemovedSponsor(org); props.setDriver(id); }} style={{color: 'red'}}>Remove Driver</Dropdown.Item>
                    </DropdownButton>
                </td>
            </tr>
        )
