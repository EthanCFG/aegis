...
const NavBar = (props) => {
  ...
  const setActiveSponsor1 = () => {
    ...
    localStorage.setItem("orgactive_ID", localStorage.getItem("orgid1"));
  ...
  const setActiveSponsor2 = () => {
    ...
    localStorage.setItem("orgactive_ID", localStorage.getItem("orgid2"));
  ...
  const setActiveSponsor3 = () => {
    ...
    localStorage.setItem("orgactive_ID", localStorage.getItem("orgid3"));
    ...
    <div>
      <nav class="navbar" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
          <div id="header-logo" class="navbar-item"></div>
        ...
        <div id="navbarBasicExample" class="navbar-menu">
          <div class="navbar-start">
            ...
            <Link to="/driver_catalog" class="navbar-start">
              <a class="navbar-item">Sponsor Catalog</a>
            </Link>
            <div class="navbar-item has-dropdown is-hoverable">
              <a class="navbar-link">Active Sponsor</a>
