...
var ComboBox = function ComboBox(_ref) {
  ...
  var backgroundColorSelector = function backgroundColorSelector(optionIndex) {
    if (optionIndex === focusIndex && optionIndex === selectedOptionIndex) return selectedOptionColor || '#63b3ed';else if (optionIndex === focusIndex) {
  ...
  return React.createElement("div", {
    className: wrapperClassName ? styles.comboBox + " " + wrapperClassName : styles.comboBox,
    style: style
